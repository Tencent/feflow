  ...
  <div class="project-wv">
    <div class="project-wv__header">
      <div class="project-wv__toolbar">
        <span
          class="project-wv__toolbar-item project-wv__toolbar-item--refresh"
          @click="handleRefresh"
        />
        <span
          class="project-wv__toolbar-item project-wv__toolbar-item--link"
          @click="handleCopyLink"
        />
        <span
          class="project-wv__toolbar-item project-wv__toolbar-item--external"
          @click="handleExternal"
        />
      </div>
      <div
        v-show="progressVisible"
        class="project-wv__progress"
      >
        <div
          class="project-wv__progress-inner"
