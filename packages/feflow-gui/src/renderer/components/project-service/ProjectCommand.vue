...
.project-command {
    ...
    &__icon {
        &-stop {
            ...
            width: 10px;
            height: 10px;
            background: url("@{imgpath}/service-stop.png") center no-repeat;
        ...
        &-run {
            ...
            width: 10px;
            height: 12px;
            background: url("@{imgpath}/service-run.png") center no-repeat;
            background-size: 100% auto;
        }
    }
    ...
    &__item {
        ...
        &-icon {
            ...
            height: 28px;
            border-radius: 14px;
            background: #fff url("@{imgpath}/service-publish.png") center no-repeat;
            background-size: 100% auto;

            &.is-running {
                background-image: url("@{imgpath}/service-running.png");
            }
        }
    ...
    &__operation {
        ...
        &-copy {
            ...
            width: 14px;
            height: 14px;
            background: url('@{imgpath}/service-copy.png') center no-repeat;
            background-size: 100% auto;
        }
        ...
        &-edit {
            ...
            width: 14px;
            height: 14px;
            background: url('@{imgpath}/service-edit.png') center no-repeat;
            background-size: 100% auto;
        }
        ...
        &-save {
            ...
            width: 14px;
            height: 14px;
            background: url('@{imgpath}/service-save.png') center no-repeat;
            background-size: 100% auto;
        }
