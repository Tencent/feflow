...
class Feflow {
    ...
    printBanner() {
        figlet.text('feflow', {
            ...
            console.log(chalk.cyan(` Feflow，当前版本${pkg.version}, 让开发工作流程更简单，主页：http://git.code.oa.com/feflow/feflow-cli     `));
    ...
    *scaffoldProject() {
        ...
        if (choices.length) {
            ...
            shell.echo(chalk.red('检测到你还未安装任何脚手架，请先安装后再进行项目初始化，参考文档：http://feflow.oa.com/docs/index.html'));
        }
    }
